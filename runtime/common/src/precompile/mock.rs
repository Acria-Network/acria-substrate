...
pub const ACRI: CurrencyId = CurrencyId::Token(TokenSymbol::ACRI);
pub const USDA: CurrencyId = CurrencyId::Token(TokenSymbol::USDA);

parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = ACRI;
}
...
parameter_types! {
	...
	pub AllNonNativeCurrencyIds: Vec<CurrencyId> = vec![CurrencyId::Token(TokenSymbol::USDA)];
}
...
pub const ACRI_ERC20_ADDRESS: &str = "0x0000000000000000000000000000000001000000";
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Currencies::update_balance(Origin::root(), ALICE, USDA, 1_000_000_000));
